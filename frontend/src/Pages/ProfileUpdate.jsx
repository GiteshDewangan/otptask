...
function ProfileUpdate() {
    ...
    const handleProfileUpdate = async () => {
        ...
        if (token) {
            ...
            try {
                const response = await axios.post('http://localhost:5000/api/profile/store', formData, {
    ...
    return (
        <div className="profile w-[100vw] h-[100vh] bg-green-100 flex justify-center items-center">
            ...
            {
                pop == true ? (
                    <div className='w-[100vw] h-[100vh] bg-[rgba(0,0,0,0.2)] flex justify-center items-center absolute top-0 bottom-0 left-0 right-0'>
            ...
            <div className=" h-40 lg:w-[40%] md:w-[50%] sm:w-[100%]  w-[100%] lg:h-[98%] md:h-[98%] sm:h-[100%]  h-auto bg-white  flex flex-col  gap-3 md:rounded-2xl lg:rounded-2xl shadow-2xl  ">
